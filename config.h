...
static const char col_1[]           = "#e6e6e6";
static const char col_2[]           = "#a05465";
static const char col_3[]           = "#121e61";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_1, col_3, col_1 },
	[SchemeSel]  = { col_1, col_2, col_2 },
};

/* tagging */
static const char *tags[] = { "term", "www",  "media", "misc" };
